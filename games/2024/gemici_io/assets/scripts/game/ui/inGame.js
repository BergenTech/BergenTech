...
export function inGame(game, bar = false) {
    ...
    if (game.enemies_arr.find(e => e instanceof FinalBoss)) {
        graphic.fill("black");
        graphic.beginShape();
        graphic.vertex(width / 2 - 215, 52 + 35);
        graphic.vertex(width / 2 + 215 + 10, 52 + 35);
        graphic.vertex(width / 2 + 215, 52 + 35 + 22);
        graphic.vertex(width / 2 - 215 - 10, 52 + 35 + 22);
        graphic.endShape(CLOSE);
    
        graphic.fill(menuColor);
        graphic.beginShape();
        graphic.vertex(width / 2 - 213, 54 + 35);
        graphic.vertex(width / 2 + 213 + 8, 54 + 35);
        graphic.vertex(width / 2 + 213, 52 + 35 + 20);
        graphic.vertex(width / 2 - 213 - 8, 52 + 35 + 20);
        graphic.endShape(CLOSE);

        graphic.fill("#aa6118");

        var boss = game.enemies_arr.find(e => e instanceof FinalBoss);
        var progress = boss.health / boss.maxHealth;
        ...
        graphic.beginShape();
        graphic.vertex(width / 2 - 213, 54 + 35);
        graphic.vertex(width / 2 - 213 + barWidth + 8, 54 + 35);
        graphic.vertex(width / 2 - 213 + barWidth, 52 + 35 + 20);
        graphic.vertex(width / 2 - 213 - 8, 52 + 35 + 20);
        graphic.endShape(CLOSE);
    }
