...
import { inGame, mainMenu, pauseMenu, tutorial, gameOver, gameWon } from "./ui.js";
...
export default class Game {
    ...
    getLocation(coordsX, coordsY) {
        return {
            x: coordsX - this.dimensions.position.x,
            y: coordsY - this.dimensions.position.y
        }
    }
    ...
    moveEntities(x, y) {
        ...
        for (var i = 0; i < this.boss_bullets.length; i ++) {
            var bullet = this.boss_bullets[i];
