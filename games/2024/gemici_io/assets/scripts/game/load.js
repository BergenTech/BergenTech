        ...
        if (this.loadTime === 0) {
            this.assets = {
                images: [
                    ...
                    ["lightning_sprites", window.game.loadImage('assets/images/sheets/lightning.png')],
                    ["ball", window.game.loadImage('assets/images/ball.png')],
                    ["portal", window.game.loadImage('assets/images/portal.png')],
                    ["boss_idle", window.game.loadImage('assets/images/sheets/boss_idle.png')],
                    ["boss_run", window.game.loadImage('assets/images/sheets/boss_run.png')],
                    ["boss_death", window.game.loadImage('assets/images/sheets/boss_death.png')],
                    ["boss_attack", window.game.loadImage('assets/images/sheets/boss_attack.png')],
                    ["boss_hurt", window.game.loadImage('assets/images/sheets/boss_hurt.png')],
                    ["dog", window.game.loadImage('assets/images/sheets/dog_all.png')],
                ],
                sounds: [
